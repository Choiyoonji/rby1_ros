...
class RBY1DataNode(Node):
    def __init__(self):
        ...
        self.buf_flags_torso_follow: List[int] = []
    ...
    def _on_tick(self, msg: UInt64):
        ...
        if st is None:
            ...
            self.buf_flags_torso_follow.append(0)
        ...
        self.buf_flags_torso_follow.append(1 if getattr(st, "is_torso_following", False) else 0)
    ...
    def _write_h5(self, path: Path):
        ...
        with h5py.File(str(path), "w") as f:
            ...
            write_vlen("left_ee_pos", self.buf_left_ee_pos)
            write_vlen("left_ee_quat", self.buf_left_ee_quat)
            ...
            write_vlen("left_ft_force", self.buf_left_ft_force)
            write_vlen("left_ft_torque", self.buf_left_ft_torque)
            ...
            g.create_dataset("is_torso_following", data=np.asarray(self.buf_flags_torso_follow, dtype=np.uint8), compression="gzip", compression_opts=4, shuffle=True, fletcher32=True, chunks=True)
    ...
    def _clear_buffers(self):
        ...
        self.buf_flags_torso_follow.clear()
